...
public:
	// Faz o construtor procurar o ID do processo
	// abre o identificador
	...
	// Destruidor que libera o identificador aberto
	~Memory()
	{
		if (processHandle)
